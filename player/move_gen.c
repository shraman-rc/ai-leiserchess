...
// Precomputations
//////////////////
static move_t move_t_primer_from[ARR_SIZE] = {
  0b000000000,
  0b100000000,
  0b1000000000,
  0b1100000000,
...
// Precompute the move_t primer for each of the from/to square combinations
// static move_t move_t_primer_to[ARR_SIZE];
// static move_t move_t_primer_from[ARR_SIZE];
// static move_t move_t_primer_typ[ARR_SIZE]; // Uncomment after testing above 2
// static move_t move_t_primer_rot[ARR_SIZE]; // Uncomment after testing above 2
move_t move_of(ptype_t typ, rot_t rot, square_t from_sq, square_t to_sq) {
  return (typ << PTYPE_MV_SHIFT) |
      (rot << ROT_SHIFT) |
      move_t_primer_from[from_sq] |
      to_sq;
}
//move_t move_of(ptype_t typ, rot_t rot, square_t from_sq, square_t to_sq) {
...
int generate_all(position_t *p, sortable_move_t *sortable_move_list,
  ...
  char laser_map[ARR_SIZE] = {
    [0   ...  47] = 4,                                        // 4444444444444444
                                                              // 4444444444444444
                                                              // 4444444444444444
    [48  ...  50] = 4, [51  ...  60] = 0, [61  ...  63] = 4,  // 4440000000000444
    [64  ...  66] = 4, [67  ...  76] = 0, [77  ...  79] = 4,  // 4440000000000444
    [80  ...  82] = 4, [83  ...  92] = 0, [93  ...  95] = 4,  // 4440000000000444  
    [96  ...  98] = 4, [99  ... 108] = 0, [109 ... 111] = 4,  // 4440000000000444 
    [112 ... 114] = 4, [115 ... 124] = 0, [125 ... 127] = 4,  // 4440000000000444   
    [128 ... 130] = 4, [131 ... 140] = 0, [141 ... 143] = 4,  // 4440000000000444 
    [144 ... 146] = 4, [147 ... 156] = 0, [157 ... 159] = 4,  // 4440000000000444 
    [160 ... 162] = 4, [163 ... 172] = 0, [173 ... 175] = 4,  // 4440000000000444
    [176 ... 178] = 4, [179 ... 188] = 0, [189 ... 191] = 4,  // 4440000000000444
    [192 ... 194] = 4, [195 ... 204] = 0, [205 ... 207] = 4,  // 4440000000000444 
                                                              // 4444444444444444
                                                              // 4444444444444444
    [208 ... 255] = 4,                                        // 4444444444444444
    ...
    for (rnk_t r = 0; r < BOARD_WIDTH; r++) {
      ...
      switch (typ) {
        ...
        case KING:
          ...
          // directions
          // Create an 8 bit string determining which positions this piece can move onto
          // i.e. if bit position 'd' is ____, then this piece cannot move in direction 'd'
          for (int d = 0; d < 8; d++) {
